...
(function ($) {
  ...
  //Triggering Link for Light/Dark Mode
  // var light_mode = document.getElementById("light_btn");
  ...
  $(".dark").on("click", function (e) {
    ...
    document.getElementById("logo_header").src =
      "/assets/images/logo/super_vet_logo_transparent.png";
